...
public class TestConsumeController {
	...
	public List<String> testProvide() {
		 ...
		 */
		ServiceInstance si = this.loadBalancerClient.choose("eureka-zuul-server");
		// 拼接访问服务的URL
		StringBuilder sb = new StringBuilder();
		// http://localhost:8081/test
		sb.append("http://").append(si.getHost()).append(":").append(si.getPort()).append("/eureka-zuul-application-service/testProvide");
